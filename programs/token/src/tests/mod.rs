...
mod tests {
    ...
    use solana_sdk::{
        account::{AccountSharedData, WritableAccount}, instruction::{AccountMeta, Instruction}, program_option::COption, program_pack::Pack, pubkey::Pubkey, sysvar::Sysvar,
    };
    ...
    fn transfer() {
        ...
        // Data
        let data = (3, 1_000_000u64.to_le_bytes().to_vec()).concat();
    ...
    fn approve() {
        ...
        // Data
        let data = (4, 1_000_000u64.to_le_bytes().to_vec()).concat();
    ...
    pub fn mint_to() {
        ...
        // Data
        let data = (7, 1_000_000u64.to_le_bytes().to_vec()).concat();
    ...
    pub fn burn() {
        ...
        // Data
        let data = (8, 1_000_000u64.to_le_bytes().to_vec()).concat();
    ...
    pub fn transfer_checked() {
        ...
        // Data
        let data = (12, 1_000_000u64.to_le_bytes().to_vec(), 6).concat();
    ...
    pub fn approve_checked() {
        ...
        // Data
        let data = (13, 1_000_000u64.to_le_bytes().to_vec(), 6).concat();
